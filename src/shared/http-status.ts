...
// Combined HTTP status codes and phrases
...
export const CONFLICT = {
  CODE: 409 as const,
  MESSAGE: "Conflict",
  TALENT_MESSAGE: "Talent already exists",
  SCHEDULE_MESSAGE: "Schedule already exists",
  INTERVIEW_MESSAGE: "Interview already exists",
  PROJECT_MESSAGE: "Project already exists",
  CONTRACT_MESSAGE: "Contract already exists",
};
...
export const NOT_FOUND = {
  CODE: 404 as const,
  MESSAGE: "Not Found",
  LOCATION_MESSAGE: "Location not found",
  LOCATION_LOG_MESSAGE: "Location log not found",
};
...
export const UNPROCESSABLE_ENTITY = {
  ...
  EMPTY_OBJECT_MESSAGE: "No updates provided",
  DATE_MESSAGE: "Check date inputs",
  INVALID_ID_MESSAGE: "Invalid ID",
  INVALID_PAGE_QUERY_MESSAGE: "Invalid page number",
  INVALID_LIMIT_QUERY_MESSAGE: "Invalid limit number",
  INVALID_SORT_QUERY_MESSAGE: "Invalid sorting order",
  INVALID_SORT_BY_QUERY_MESSAGE: "Invalid sorting field",
  INVALID_STATUS_QUERY_MESSAGE: "Invalid status",
